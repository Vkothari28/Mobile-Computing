...
private const val REQUEST_PHOTO_2 = 2
...
class BasketballGameFragment : Fragment() {
    ...
    private fun updatePhotoView2() {
        if (photoFile2.exists()) {
            val bitmap = getScaledBitmap(photoFile2.path, requireActivity())
    ...
    private fun initializePhotoVars() {
        ...
        photoUri= FileProvider.getUriForFile(requireActivity(), "basketballCounter.fileprovider", photoFile!!)
        photoFile2 = gameDetailViewModel.getTeamBPhotoFile(game)
        photoUri2 = FileProvider.getUriForFile(requireActivity(), "basketballCounter.fileprovider", photoFile2!!)
    }
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == REQUEST_PHOTO_2) {
    ...
    override fun onStart() {
        ...
        photoButton2.apply {
            ...
            setOnClickListener {
                ...
                startActivityForResult(captureImage, REQUEST_PHOTO_2)
            }
        }
    }
